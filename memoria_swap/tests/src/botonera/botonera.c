...
void probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ(){
    ...
    pthread_mutex_lock(&sum_mutex);
    warning_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ","------------------------------------------");
    // Iniciamos un hilo detached que corra el servidor de memoria
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%s", "config pasado x parametro: ", ruta_config);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "Pid pasado x parametro: ", pid1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "tamanio pasado x parametro: ", tamanio1);

    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "Pid pasado x parametro: ", pid2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "tamanio pasado x parametro: ", tamanio2);

    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "Pid pasado x parametro: ", pid3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "tamanio pasado x parametro: ", tamanio3);

    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "Pid pasado x parametro: ", pid4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "tamanio pasado x parametro: ", tamanio4);
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RECIBIDO: ", codop);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_VALUE_TAB_PAG);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL RECIBIDO: ", valor_tabla_1er_nivel_pid1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL Esperado: ", 0);

    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RECIBIDO: ", codop2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_VALUE_TAB_PAG);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL RECIBIDO: ", valor_tabla_1er_nivel_pid2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL Esperado: ", 1);

    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RECIBIDO: ", codop3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_VALUE_TAB_PAG);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL RECIBIDO: ", valor_tabla_1er_nivel_pid3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL Esperado: ", 2);

    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RECIBIDO: ", codop4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_VALUE_TAB_PAG);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL RECIBIDO: ", valor_tabla_1er_nivel_pid4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "TABLA_1ER_NIVEL Esperado: ", 3);
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA1 RECIBIDO: ", codopRTA1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_1ER_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA1 RECIBIDO: ", PIDRTA1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA1 Esperado: ", pid1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID1 RECIBIDO: ", POSICION_TABLA_2DO_NIVEL_PID1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID1 Esperado: ", 0);
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA2 RECIBIDO: ", codopRTA2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_1ER_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA2 RECIBIDO: ", PIDRTA2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA2 Esperado: ", pid2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID2 RECIBIDO: ", POSICION_TABLA_2DO_NIVEL_PID2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID2 Esperado: ", 4);
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA3 RECIBIDO: ", codopRTA3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_1ER_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA3 RECIBIDO: ", PIDRTA3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA3 Esperado: ", pid3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID3 RECIBIDO: ", POSICION_TABLA_2DO_NIVEL_PID3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID3 Esperado: ", 8);
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA4 RECIBIDO: ", codopRTA4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_1ER_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA4 RECIBIDO: ", PIDRTA4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "PIDRTA4 Esperado: ", pid4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID4 RECIBIDO: ", POSICION_TABLA_2DO_NIVEL_PID4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "POSICION_TABLA_2DO_NIVEL_PID4 Esperado: ", 12);


    warning_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ","mando 4 msjs de opcode acceso 2do nivel");
    ...
    warning_log("----","------------------------------------------------");
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA1 RECIBIDO: ", opcodee1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_2DO_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd1 RECIBIDO: ", pidd1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd1 Esperado: ", 123);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco RECIBIDO: ", marco1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco Esperado: ", 0);
    warning_log("----","------------------------------------------------");
    ...
    warning_log("----","------------------------------------------------");
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA2 RECIBIDO: ", opcodee2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_2DO_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd2 RECIBIDO: ", pidd2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd2 Esperado: ", 255);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco RECIBIDO: ", marco2);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco Esperado: ", 1);
    warning_log("----","------------------------------------------------");
    ...
    warning_log("----","------------------------------------------------");
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA3 RECIBIDO: ", opcodee3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_2DO_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd3 RECIBIDO: ", pidd3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd3 Esperado: ", 128);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco RECIBIDO: ", marco3);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco Esperado: ", 2);
    warning_log("----","------------------------------------------------");
    ...
    warning_log("----","------------------------------------------------");
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP RTA4 RECIBIDO: ", opcodee4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "CODOP esperado: ", OPCODE_ACCESO_2DO_NIVEL);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd4 RECIBIDO: ", pidd4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "pidd4 Esperado: ", 128);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco RECIBIDO: ", marco4);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "%s%d", "marco Esperado: ", 3);
    warning_log("----","------------------------------------------------");

    warning_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "Arranco a probar los WRITE");
    ...
    format_warning_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ","ENVIANDO OPCODE_WRITE con PID:%i DF:%i Contenido:%i", pidd1, direccion_fisica_write_1,(int) contenido_write_1 );
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ",  "Respuesta WRITE RECIBIDA(opcode):%i", (int)respuesta_write_1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "Respuesta WRITE Esperada: %i", (int)OPCODE_ACK_OK);
    warning_log("----","------------------------------------------------");
    ...
    send_codigo_op_con_numero(sockett, OPCODE_SUSPENDER_PROCESO, pid1);

    uint32_t respuesta_suspender_1;
    recv(sockett, &respuesta_suspender_1, sizeof(uint32_t), false);


    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ",  "PID(%i)Respuesta SUSPENDER RECIBIDA(ack):%i", (int)pid1, (int)respuesta_suspender_1);
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "PID(%i)Respuesta SUSPENDER ESPERADA(ack):%i", (int)pid1, (int)OPCODE_ACK_OK);
    warning_log("----","------------------------------------------------");
    ...
    format_warning_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ","ENVIANDO READ con PID:%i DF:%i", pidd1, direccion_fisica_write_1 );

    uint32_t marco_para_read_1 = hacer_acceso_1er_y_2do_nivel(sockett, pid1, valor_tabla_1er_nivel_pid1, 0);

    int desplazamiento_para_read_1 = 0;
    uint32_t direccion_fisica_para_read = marco_para_read_1 * mem_swap_config->tam_pagina + desplazamiento1;
    ...
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ",  "Respuesta READ RECIBIDA Opcode:%i PID:%i Contenido: %i", (int)opcode_rta_1, (int)pid_rta_1, (int)lectura_1) ;
    format_info_log("botonera.c@probar_VALUE_TAB_PAG_y_OPCODE_ACCESO_1ER_NIVEL_con_varios_procesos_y_OPCODE_ACCESO_2DO_NIVEL_y_OPCODE_WRITE_y_OPCODE_SUSPEND_y_OPCODE_READ", "Respuesta READ Esperada: %i PID:%i Contenido: %i", (int)OPCODE_READ,(int) pidd1, 12052000 );
    warning_log("----","------------------------------------------------");
    ...
    CU_ASSERT_EQUAL(respuesta_suspender_1, OPCODE_ACK_OK);
